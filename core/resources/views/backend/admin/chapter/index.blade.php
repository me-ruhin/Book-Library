      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title mb-0">Chapter Infromation</h3>
          ...
          <div class="content-header-right col-md-6 col-12">
            <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
              ...
              <a class="btn btn-info  dropdown-menu-right"  href="{{route('admin.chapter.create')}}" type="button" ><i class="ft-pen icon-left"></i> Add Chapter</a>
            </div>
          </div>
        </div>
                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            ...
                            <tr class="">
                                ...
                                <td> <a href="{{route('admin.chapter.edit',$data->id)}}" class="btn btn-warning">Edit</a>

                                 || <button type="submit" onclick="deletepost('{{$data->id}}')" class="btn btn-danger"> Delete </button>


                                 <form action="{{route('admin.chapter.destroy',$data->id)}}" id="delete-form-{{$data->id}}" method="POST" >
                                              @csrf
                                             @method('delete')
