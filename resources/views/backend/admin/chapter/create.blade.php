      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title mb-0">Create Chapter</h3>
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"><a href="{{route('admin.chapter.create')}}">Create Chapter</a>
                  </li>
                </ol>
              </div>
            </div>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="basic-layout-card-center">Create Chapter</h4>
                        ...
                        <form class="form">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="cName" class="form-control" placeholder="Chapter Name" name="chapterName" required="">
                                </div>   
